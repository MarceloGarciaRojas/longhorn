...
| 10A.3 | Contrato de contenido `gym.v1` y compatibilidad segura | — | 1 | 2026-08 | Implementada y validada localmente; CI pendiente | [etapa-10a3-gym-v1.md](etapa-10a3-gym-v1.md) | Vigente | Schema, validación, borrador y referencias multimedia Gym; cero renderer, plantilla, editor, onboarding y publicación Gym. |
