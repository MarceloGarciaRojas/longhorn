...
| 10A.5 | Registro técnico, catálogo y preview de Pulso Club | — | 1 | 2026-08 | Implementada y validada; lista para revisión en Draft | [etapa-10a5-registro-preview-pulso.md](etapa-10a5-registro-preview-pulso.md) | Vigente | Una plantilla Gym registrada para preview privado; selección, publicación, restauración, editor y onboarding permanecen bloqueados. Audit final: 0/0/0/0 tras la remediación separada de `nanoid`. |
