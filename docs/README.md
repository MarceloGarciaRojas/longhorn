...
| 10A.2 | Generalización mínima del núcleo Restaurant + Gym | — | 1 | 2026-08 | Auditada; lista para revisión humana | [etapa-10a2-generalizacion-multirubro.md](etapa-10a2-generalizacion-multirubro.md) | Vigente | Puerta 10A.2-M aprobada localmente; industrias cerradas Restaurant/Gym, núcleo fail-closed y persistencia preparada; `gym.v1`, renderer, plantilla, editor y onboarding Gym continúan no implementados. |
| 10A.3 | Contrato de contenido `gym.v1` y compatibilidad segura | — | 1 | 2026-08 | Auditada; lista para revisión humana | [etapa-10a3-gym-v1.md](etapa-10a3-gym-v1.md) | Vigente | Schema, validación, borrador y referencias multimedia Gym; cero renderer, plantilla, editor, onboarding y publicación Gym. |
| 10A.4 | Renderer aislado Pulso Club | — | 1 | 2026-08 | Implementada localmente; integración funcional no iniciada | [etapa-10a4-renderer-pulso-club.md](etapa-10a4-renderer-pulso-club.md) | Vigente | Vista `gym-pulso-v1` compatible solo con `gym.v1`; permanece fuera de manifest, catálogo, preview, selección, publicación, editor y onboarding. |
