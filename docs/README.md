...
| 9B.1–9B.3 | Contrato, renderer y preview de Restaurante Editorial | — | 1 | 2026-08 | Registrada y previsualizable; no seleccionable, publicable ni habilitada en onboarding | [etapa-9b-contrato-restaurant-editorial.md](etapa-9b-contrato-restaurant-editorial.md) | Vigente | Registro cerrado, seed local/CI, preview privado, evidencia visual y bloqueos server-side; no constituye disponibilidad comercial. |
| DT | Registro central de deuda técnica | DT-001–DT-007 | 1 | 2026-08 | Vigente | [deuda-tecnica.md](deuda-tecnica.md) | Sí | Condiciones de cierre y bloqueos para merge, staging y producción. |
