...
| 10A.1 | Contrato visual, de contenido y compatibilidad de Landing Gimnasio | — | 1 | 2026-08 | Contrato definido; implementación bloqueada por gobierno | [etapa-10a-contrato-gimnasio.md](etapa-10a-contrato-gimnasio.md) | Propuesto | Preservación de Pulso Club, `gym.v1` conceptual, una plantilla con variantes Volt/Studio/Forge, alcance B1 y generalización futura sin código. |
