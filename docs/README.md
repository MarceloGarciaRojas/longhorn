...
| 10B.1 | Entorno Alfa mínimo e infraestructura persistente | — | 1 | 2026-08 | Listo para aprovisionar; no desplegado | [etapa-10b1-entorno-alfa.md](etapa-10b1-entorno-alfa.md) | Vigente | Ambiente Alpha fail-closed, stack Cloudflare/Supabase, adaptador de objetos, migración 0016, comandos operacionales y [runbook](runbook-alpha.md). |
...
| ADR-013 | Infraestructura Alfa Cloudflare y Supabase | ADR | 1 | 2026-08 | Aceptado para preparación; aprovisionamiento pendiente | [adr/ADR-013-infraestructura-alpha-cloudflare-supabase.md](adr/ADR-013-infraestructura-alpha-cloudflare-supabase.md) | Parcial | Workers/Hyperdrive + Supabase PostgreSQL/Auth/Storage; sin despliegue ni procesamiento multimedia Alfa. |
